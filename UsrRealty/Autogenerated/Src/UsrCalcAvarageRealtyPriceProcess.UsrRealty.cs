namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAvarageRealtyPriceProcessMethodsWrapper

	/// <exclude/>
	public class UsrCalcAvarageRealtyPriceProcessMethodsWrapper : ProcessModel
	{

		public UsrCalcAvarageRealtyPriceProcessMethodsWrapper(Process process)
			: base(process) {
